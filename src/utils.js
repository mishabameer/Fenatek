      ...
      return {
        ...
        products: [
          ...
          },
          {
            ...
            subCategories: [
              { id: 4051, name: "Dust and Chip Aspirators" },
              { id: 4052, name: "Oil Aspirators" },
            ],
          },
          {
            id: 406,
            ...
            subCategories: [
              ...
              { id: 4062, name: "Frames and Protections" },
              { id: 4063, name: "Perimeter Protections" },
              { id: 4064, name: "Floor marking stickers and Tools" },
              { id: 4065, name: "Safety Lighting" },
              { id: 4066, name: "Visual Management Tools" },
              { id: 4067, name: "Signalling and Alarm Solutions" },
            ],
          },
          { id: 407, name: "Inkjet Printing" },
          { id: 408, name: "Electric Cutters" },
          { id: 409, name: "Industrial Soundproofing Systems" },
          { id: 410, name: "Industrial Doors" },
          { id: 411, name: "Industrial Flooring Solutions" },
          { id: 412, name: "Filter pumps" },
          { id: 413, name: "Industrial Springs" },
          { id: 414, name: "Turbine Roof Ventilators" },
